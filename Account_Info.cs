...
namespace Parking_Finder
{
    public partial class Account_Info : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)//Save Click
        {
            ...
            else if (textBox3.Text != "" && textBox3.TextLength < 11)
            {
            ...
            else
            {
                ...
                if (r > 0)
                {
                    ...
                    if (textBox2.Text != "")
                    {
                        ...
                        int id = controllerObj.getClientID(textBox4.Text);
                        int c = controllerObj.Insert_Card(Convert.ToInt64(textBox2.Text), id);
                        if (c == 0)
                            MessageBox.Show(" Please enter correct credit card number!");
